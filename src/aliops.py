...
async def check(request):
    ...
    servers = dict(
        ...
        O2O19='172.18.0.206', O2O20='172.18.208', O2O21='172.18.0.213', O2O22='172.18.0.212', O2O23='172.18.0.217',
        O2O24='172.18.0.216', O2O25='172.18.203.241', O2O26='172.18.203.243', O2O27='172.18.203.244'
    )
    tasks = [
        _get_status(domain, host) for host in servers.values()
    ]
